                ...
                <div class="comment">
                    <div class="head">
                        <h5>{{ $comment->email }} - <strong class='user'> {{ $comment->name }}</strong>
                            ...
                            <a href="{{ route('edit-comment', ['id' => $comment->id, 'idArticle' => $idArticle]) }}" class="btn btn-info">Edit</a>
                            <a href="{{ route('delete-comment', ['id' => $comment->id, 'idArticle' => $idArticle]) }}" class="btn btn-danger">Delete</a>
